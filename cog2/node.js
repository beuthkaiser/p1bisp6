...
define(["exports", "shader"], function(exports, shader) {
	...
	function create(_name, _model, _parent, _isLightNode, _visible) {
		...
		//console.log("cog2.node.create:" + _model);
		if(!_name || !_model) {
	...
	function updateModelview() {
		...
		if(!this.localModelviewUpToDate) {
            ...
            var s = this.transformation.shear[0];
            var u = this.transformation.shear[1];
            var t = this.transformation.shear[2];
                
            this.localShear=[1,s,u,0,
                             t,1,u,0,
                             t,s,1,0,
                             0,0,0,1];        
          ...
          // this.getModelData().calcuatePolygonNormalsFromMesh.apply(this.getModelData());    
