 ...
 * @module app
 */
define(["exports", "layout", "ui", "scene", "animation", "importerOBJ"], //
function(exports, layout, ui, scene, animation, importerOBJ) {
    "use strict";
	...
	function load() {
		 ...
		 //            fetch('PlaneTextured.obj')
  //     fetch('ChessPiece.obj')
  //.then(response => response.text())
  //.then(text =>
  //      {
			
	  importerOBJ.init( function() {
 //  	alert(importerOBJ.getTexts());
