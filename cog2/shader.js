...
define(["exports"], function(exports) {
	 ...
	 */
	function setShadingFunctionName(functionName) {
		shadingFunctionName = functionName;
		shadingFunction = this[functionName];
